...
export const Default: Story<Props> = args => (
	<Accordion {...args}>
		...
		urna convallis ut. Mauris blandit justo mi, ac lobortis eros tempor sed. Curabitur eget dui
		nibh. Mauris faucibus porta mauris a tempor. Ut eu orci molestie, egestas urna eget, aliquet
		ante. Nunc id lacus non neque pharetra ultricies. Nullam lobortis est quam, eu vehicula
		velit finibus vitae. Sed suscipit enim mauris, nec scelerisque neque dictum vel.
	</Accordion>
)
